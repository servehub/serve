module github.com/servehub/serve

go 1.17

require (
	github.com/adobe-platform/go-metronome v0.0.0-20170606162009-58e096fb2116
	github.com/cenk/backoff v2.0.1-0.20180518090649-f756bc9a37f8+incompatible
